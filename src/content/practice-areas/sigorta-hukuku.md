...
order: 5
summary: Trafik kazasından doğan tazminat talepleri, değer kaybı ve sigorta uyuşmazlıkları.
description: Trafik kazası tazminatı, araç değer kaybı, hasar ödemesi uyuşmazlıkları ve Sigorta Tahkim Komisyonu başvuruları.
matters:
  - Araç değer kaybı ve mahrumiyet bedeli talepleri
  - Trafik kazasından doğan maddi ve manevi tazminat davaları
  - Destekten yoksun kalma tazminatı
  - Kasko ve zorunlu trafik sigortası ödeme uyuşmazlıkları
  - Sigorta Tahkim Komisyonu'na başvuru
  - Rücu davaları
laws:
  - code: '6102'
    name: Türk Ticaret Kanunu (Sigorta Hukuku kitabı)
  - code: '5684'
...
Trafik kazasından doğan taleplerde, zarar görenin doğrudan sigorta şirketine başvurma hakkı vardır. Zorunlu mali sorumluluk sigortasında sigortacıya başvurulması, dava açılmadan önce yerine getirilmesi gereken bir dava şartıdır (Karayolları Trafik Kanunu m. 97). Sigortacı, başvurudan itibaren on beş gün içinde ödeme yapmazsa dava veya tahkim yoluna gidilebilir.
